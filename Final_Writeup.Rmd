...
Code found in file: Data_Cleaning.rmd 
...
Code found in file: Bee_Analysis.rmd


IV. Visualizations: 

These first two figures were made to summarize the raw data in two different ways. The code for these figures can be found in the Oregon_Bee_Map.rmd script. 
...
The three figures below showcases the predicted linear trend for spring temperature, urbanization, and species specific response. The code for these scripts can be found in the BombusModelFigures.rmd script. 
